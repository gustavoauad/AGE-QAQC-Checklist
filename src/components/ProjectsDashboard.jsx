...
export default function ProjectsDashboard({ session, onSelectProject, onSignOut }) {
  ...
  const handleDelete = async (e, projectId) => {
    e.stopPropagation();
    if (!window.confirm("Are you sure you want to delete this project? This will delete all checklists and cannot be undone.")) return;
          ...
          <div style={{ display: "grid", gap: "16px" }}>
            {projects.map(({ role, project }) => (
              <div
                ...
                style={{ background: "#1e293b", border: "1px solid #334155", borderRadius: "12px", padding: "24px", cursor: "pointer", transition: "border-color 0.2s", position: "relative" }}
